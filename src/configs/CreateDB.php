<?php
	...
	$query[] = "CREATE TABLE ST_RATING(ST_RATING_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, ST_ID INT, RATING VARCHAR(30), TotalVisitor INT, CONSTRAINT FOREIGN KEY(ST_ID) REFERENCES WriteSomething(S_ID));"
